...
#./build/cadical -q -t 60 --compact=false --shufflequeue=false ../instances/sc2021/Kakuro-easy-051-ext.xml.hg_4.cnf.xz
./build/cadical -q -t 60 --compact=false --shufflescores=false ../instances/sc2021/Kakuro-easy-051-ext.xml.hg_4.cnf.xz
